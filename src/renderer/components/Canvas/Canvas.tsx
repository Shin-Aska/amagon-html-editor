        ...
        <div className="canvas-wrapper" style={{display: 'flex', flexDirection: 'column'}}>
            {activeTabEditBlockId && activeTabIndex !== null && (
                <div className="tab-edit-toolbar" style={{
                    ...
                    <div>
                        <strong><Layers size={14} style={{verticalAlign: 'middle', marginRight: 4}}/> Editing Tab
                            Content</strong>
                    </div>
                    <button
            ...
            >
                ...
                {tabWarningVisible && showTabChildSelectionWarning && (
                    <div className="canvas-warning-toast" role="status" aria-live="polite">
                        <div className="canvas-warning-message">You are trying to select a component inside a tab
                            component
                        </div>
                        <div className="canvas-warning-actions">
                            <button type="button" className="canvas-warning-btn"
            ...
            {contextMenu && <ContextMenu x={contextMenu.x} y={contextMenu.y} items={menuItems}
