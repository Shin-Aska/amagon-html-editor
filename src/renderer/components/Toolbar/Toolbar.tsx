                ...
                <div className={`toolbar-collapsible ${mobileMenuOpen ? 'open' : ''}`}>
                    ...
                    <div className="toolbar-section">
                        ...
                        <button className="toolbar-btn" onClick={handlePaste} disabled={!clipboard} title="Paste"
                                aria-label="Paste block from clipboard">
                            <Clipboard size={16} aria-hidden="true"/>
                        </button>
                        <button className="toolbar-btn" onClick={handleDelete} disabled={!selectedBlockId}
                                title="Delete" aria-label="Delete selected block">
                    ...
                    <div className="toolbar-section toolbar-center">
                        ...
                        <div className="toolbar-group">
                            ...
                            <div className="toolbar-divider"/>
                            <div className="toolbar-zoom-group" data-tutorial="toolbar-zoom"
