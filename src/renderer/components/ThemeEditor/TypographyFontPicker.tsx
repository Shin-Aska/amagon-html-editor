...
const FONT_OPTIONS: FontOption[] = [
  ...
  {
    label: "Figtree",
    value: "Figtree, system-ui, sans-serif",
    group: "Sans-Serif",
  },
  {
    label: "Arial",
...
export default function TypographyFontPicker({
  label,
  value,
  onChange,
}: Props): JSX.Element {
  ...
  const groups = useMemo(() => {
    return GROUPS.map((g) => ({
      group: g,
      items: filteredOptions.filter((o) => o.group === g),
  ...
  return (
    <div className="tfp-field">
      ...
      >
        ...
        <span
          className="tfp-trigger-sample"
          style={{ fontFamily: value || "inherit" }}
        >
          Aa
        </span>
        <span
          className="tfp-trigger-label"
          style={{ fontFamily: value || "inherit" }}
        >
          {currentOption.label}
        </span>
        <svg
          className="tfp-trigger-chevron"
          viewBox="0 0 10 6"
          width="10"
          height="6"
          fill="none"
