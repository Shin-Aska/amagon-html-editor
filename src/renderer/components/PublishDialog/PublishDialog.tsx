            ...
            <div className="publish-modal" data-tutorial="publish-modal" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="publish-stepper">
                    {STEPPER_LABELS.map((label, i) => (
                        <div key={label}
                             className={`publish-stepper-item${i < activeStepIndex ? ' is-done' : ''}${i === activeStepIndex ? ' is-current' : ''}`}>
                            {i > 0 && <div
                                className={`publish-stepper-connector${i <= activeStepIndex ? ' is-active' : ''}`}/>}
                        ...
                        <div className="publish-step">
                            ...
                            <div className="publish-binding-card">
                                ...
                                <p className="publish-binding-copy">
                                    Keep this publishing destination attached to the current project so the workflow
                                    opens with the right provider next time.
                                </p>
                                <div className="publish-binding-separator"/>
                                <label
                                    className={`publish-checkbox-styled publish-checkbox-indented${!bindToProject ? ' is-disabled' : ''}`}>
                                    <input
                                        type="checkbox"
                                ...
                                <p className="publish-binding-copy">
                                    Saved credentials will appear in Credentials and Global Settings for reuse across
                                    projects.
                                </p>
                            </div>
                        ...
                        <div className="publish-step">
                            {validationResult.issues.length === 0 ? (
                                <div className="publish-success-banner">
                                    <svg className="publish-success-banner-icon" width="18" height="18"
                                         viewBox="0 0 18 18" fill="none" stroke="currentColor" strokeWidth="2.5"
                                ...
                                <>
                                    ...
                                    <ul className="publish-issues">
                                        {validationResult.issues.map((issue, index) => (
                                            <li key={index}
                                                className={`publish-issue publish-issue--${issue.severity}`}>
                ...
                <div className="publish-footer">
                    ...
                    {step === 'credentials' && (
                        <button className="publish-btn-primary" onClick={handleValidate}
                                data-tutorial="publish-validate-btn">
                            Validate
                        </button>
                    )}
