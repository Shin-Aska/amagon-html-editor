    ...
    return (
        <div className="block-actions-editor">
            <div className="action-buttons-grid">
                ...
                <button className={`action-btn ${isLocked ? 'active' : ''}`} onClick={handleToggleLock}
                        title={isLocked ? "Unlock Block" : "Lock Block"}>
                    <span className="action-icon">{isLocked ? <Lock size={14}/> :
                        <LockOpen size={14}/>}</span> {isLocked ? 'Unlock' : 'Lock'}
                </button>
            </div>

            <button className="action-btn primary-action-btn mt-2" onClick={handleSaveAsUserBlock}
            ...
            <button className="action-btn danger-action-btn mt-2" onClick={handleDelete} title="Delete Block"
                    disabled={isLocked}>
