...
export default function AssetManager({onClose, onSelect}: AssetManagerProps): JSX.Element {
    ...
    const overlay = (
        <div className="asset-manager-overlay" onClick={onClose}>
            <div className="asset-manager-modal" data-tutorial="asset-manager-modal"
                            ...
                            <div className="asset-manager-grid">
                                {filteredAssets.length === 0 && !loading ? (
                                    <div className="am-empty-state">
                                        ...
                                        <p className="am-empty-hint">Click "Add Media" to import files, or drag images
                                            directly onto the canvas.</p>
                                    </div>
                                ) : (
                                            ...
                                            <div className="am-asset-thumbnail">
                                                {asset.type === 'video' ? (
                                                    <div className="am-video-thumbnail">
                                                        ...
                                                        <div className="am-play-icon"><Play size={16}
