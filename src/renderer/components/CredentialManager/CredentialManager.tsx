...
export default function CredentialManager({open, onClose}: CredentialManagerProps): JSX.Element | null {
    ...
    const DANGEROUS_CRED_IDS = ['ai:gemini-cli', 'ai:junie-cli'];
        ...
        <div className="cred-manager-popover" ref={popoverRef}>
          ...
          {secure
              ...
              : <>
                  ...
                  {' '}<a className="cred-security-info-link" onClick={() => setShowSecurityInfo(true)}>Click here for
                  more info</a>
              </>}
        </span>
            </div>
                ...
                <div className="cred-security-modal-overlay" onClick={() => setShowSecurityInfo(false)}>
                    <div className="cred-security-modal" onClick={(e) => e.stopPropagation()}>
                        <div className="cred-security-modal-header">
                            ...
                            <button className="cred-manager-close" onClick={() => setShowSecurityInfo(false)}
                                    title="Close">
                                <X size={14}/>
                            </button>
                        </div>
                        <div className="cred-security-modal-body">
                            <p>
                                ...
                                Instead, your API keys are encrypted using a key derived from machine-specific
                                identifiers
                            ...
                            <div className="cred-security-section good">
                                ...
                                <ul>
                                    <li>Your keys are <strong>never stored in plain text</strong> &mdash; they are
                                        always encrypted at rest.
                                    </li>
                                    <li>The encryption key is derived automatically, so there is <strong>no extra
                                        setup</strong> required.
                                    </li>
                                    <li>Keys are <strong>tied to this machine</strong>, making them non-portable and
                                        harder to leak accidentally.
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="cred-security-section caution">
                                ...
                                <ul>
                                    <li>Machine-derived keys are <strong>less secure</strong> than an OS keyring backed
                                        by a user password or hardware TPM.
                                    </li>
                                    <li>Any process running as your user on this machine could <strong>potentially
                                        derive the same key</strong>.
                                    </li>
                                    <li>If your machine ID or hostname changes, stored credentials <strong>may become
                                        unreadable</strong> and need to be re-entered.
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="cred-security-section recommendation">
                                ...
                                <p>
                                    ...
                                    (e.g. <code>gnome-keyring</code> or <code>kwallet</code>) and restarting the
                                    application.
