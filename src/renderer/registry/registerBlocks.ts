...
export function registerBlocks(): void {
    ...
    componentRegistry.register({
        ...
        propsSchema: {
            ...
            responsiveSm: {
                ...
                label: 'SM Height',
                default: '',
                description: 'Override height at sm breakpoint'
            },
            responsiveMd: {
                type: 'text',
                label: 'MD Height',
                default: '',
                description: 'Override height at md breakpoint'
            },
            responsiveLg: {
                type: 'text',
                label: 'LG Height',
                default: '',
                description: 'Override height at lg breakpoint'
            },
            responsiveXl: {
                type: 'text',
                label: 'XL Height',
                default: '',
                description: 'Override height at xl breakpoint'
            }
        }
    });
    ...
    componentRegistry.register({
        ...
        propsSchema: {
            ...
            anchorId: {
                ...
                label: 'Anchor ID',
                default: '',
                description: 'Adds id attribute for scroll anchors'
            },
            decorative: {
                type: 'select',
                label: 'Decoration',
        ...
        defaultChildren: [
            {
                ...
                children: [
                    ...
                    {
                        type: 'paragraph',
                        props: {text: 'A short hero description goes here.'},
        ...
        defaultChildren: [
            ...
            },
            {
                ...
                children: [
                    ...
                    {
                        type: 'paragraph',
                        props: {text: 'Some quick example text to build on the card title.'},
                        classes: ['card-text']
                    },
                        ...
                        children: [
                            {
                                ...
                                children: [{
                                    type: 'heading',
                                    props: {text: 'Free', level: 4},
                                    classes: ['my-0', 'fw-normal']
                                }]
                            },
                            {
                                type: 'container', // body
                                ...
                                children: [
                                    {
                                        type: 'heading',
                                        props: {text: '$0', level: 1},
                                        classes: ['card-title', 'pricing-card-title']
                                    },
                                    {
                                        type: 'list',
                                        props: {items: ['10 users included', '2 GB of storage', 'Email support', 'Help center access']},
                                        classes: ['list-unstyled', 'mt-3', 'mb-4']
                                    },
                                    {
                                        type: 'button',
                                        props: {text: 'Sign up for free', type: 'button'},
                                        classes: ['w-100', 'btn', 'btn-lg', 'btn-outline-primary']
                                    }
                                ]
                            }
                        ]
                ...
                children: [
                    {
                        ...
                        props: {
                            ...
                            footer: 'Someone famous in Source Title'
                        },
                        classes: ['blockquote', 'mb-0']
                    }
                ]
            }
        ],
    ...
    componentRegistry.register({
        ...
        defaultChildren: [
            ...
            {
                type: 'heading',
                props: {text: 'Centered hero', level: 1},
                classes: ['display-5', 'fw-bold', 'text-body-emphasis']
            },
            {
                type: 'column',
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        children: [
                            {
                                type: 'button',
                                props: {text: 'Primary button', type: 'button'},
                                classes: ['btn', 'btn-primary', 'btn-lg', 'px-4', 'gap-3']
                            },
                            {
                                type: 'button',
                                props: {text: 'Secondary', type: 'button'},
                                classes: ['btn', 'btn-outline-secondary', 'btn-lg', 'px-4']
                            }
                        ]
                    }
                ]
    ...
    componentRegistry.register({
        ...
        propsSchema: {
            id: {
                ...
                description: 'To trigger programmatically: bootstrap.Modal.getOrCreateInstance(document.getElementById("your-modal-id")).show()'
            },
            ...
            items: [
                {
                    ...
                    description: 'Initial team assembled and first concept validated.',
                    icon: '🚀',
                    variant: 'primary'
                },
                {
                    date: '2023',
                    title: 'Public Launch',
                    description: 'Core platform released with first enterprise customers.',
                    icon: '🎯',
                    variant: 'success'
                },
                {
                    ...
                    description: 'Expanded to new markets and launched multilingual support.',
                    icon: '🌍',
                    variant: 'info'
                }
            ],
            ...
            steps: [
                {
                    number: '1',
                    title: 'Discover',
                    description: 'Understand goals, constraints, and user context.',
                    icon: '🔍'
                },
                {
                    number: '2',
                    title: 'Build',
                    description: 'Design, prototype, and implement validated solutions.',
                    icon: '🛠'
                },
                {
                    number: '3',
                    title: 'Launch',
                    description: 'Deploy, monitor, and continuously improve outcomes.',
                    icon: '🚀'
                }
            ],
            layout: 'horizontal',
    ...
    componentRegistry.register({
        ...
        propsSchema: {
            ...
            description: {
                type: 'textarea',
                label: 'Description',
                default: 'Get the latest updates right in your inbox.'
            },
