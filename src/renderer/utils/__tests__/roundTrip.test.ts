...
describe('round-trip: blocks → HTML → blocks', () => {
                    ...
                    tabs: [
                        {
                            ...
                            blocks: [
                                ...
                                createBlock('checkbox', {
                                    props: {label: 'Check me', checked: true},
                    ...
                    tabs: [
                        {
                            ...
                            blocks: [
                                ...
                                createBlock('image', {
                                    props: {
                                        src: 'app-media://project-asset/assets/web-1774176696305.jpg',
                                        alt: 'Image'
                                    }, classes: ['img-fluid']
                                })
                            ]
    ...
    it('preserves phase 4 layout/component blocks through Bootstrap HTML round-trip', () => {
        const original: Block[] = [
            ...
            createBlock('list', {
                props: {items: ['Item A', 'Item B', 'Item C'], horizontal: true},
                classes: ['list-inline']
            }),
            ...
            createBlock('tabs', {
                props: {
                    ...
                    variant: 'pills',
                    vertical: false,
                    tabs: [{label: 'Tab A', content: 'Tab A content'}]
                },
                classes: []
            }),
            createBlock('carousel', {
    ...
    it('preserves phase 6 utility blocks through Bootstrap HTML round-trip', () => {
        const original: Block[] = [
            ...
            createBlock('map-embed', {
                props: {
                    embedUrl: 'https://maps.google.com/?q=123+Main+St',
