...
- Only visible previews mount. Edits coalesce over 150ms; leaving the viewport or switching to Classic releases the frame. No autoplay, embedded third-party frames, project scripts, or editor-selection overlays run in thumbnails. No decorative preview animation.
